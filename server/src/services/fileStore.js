...
export async function createQuoteRequest(payload) {
  return updateDatabase((database) => {
    ...
    const quoteRequest = {
      ...
      communicationStatus: payload.communicationStatus || "new",
      lastClientContactedAt: payload.lastClientContactedAt || null,
      lastClientContactedBy: payload.lastClientContactedBy || null,
      lastClientContactType: payload.lastClientContactType || "",
