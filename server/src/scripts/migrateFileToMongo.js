  ...
  for (const quoteRequest of database.quoteRequests || []) {
    await upsertBy(
      ...
      },
      {
        ...
        assignedManager: idMaps.users.get(quoteRequest.assignedManager) || null,
        communicationStatus: quoteRequest.communicationStatus || "new",
        lastClientContactedAt: quoteRequest.lastClientContactedAt ? asDate(quoteRequest.lastClientContactedAt) : null,
        lastClientContactedBy: idMaps.users.get(quoteRequest.lastClientContactedBy) || null,
        lastClientContactType: quoteRequest.lastClientContactType || "",
  ...
  for (const booking of database.bookings || []) {
    const saved = await upsertBy(
      ...
      },
      {
        ...
        assignedManager: idMaps.users.get(booking.assignedManager) || null,
        communicationStatus: booking.communicationStatus || "new",
        lastClientContactedAt: booking.lastClientContactedAt ? asDate(booking.lastClientContactedAt) : null,
        lastClientContactedBy: idMaps.users.get(booking.lastClientContactedBy) || null,
        lastClientContactType: booking.lastClientContactType || "",
