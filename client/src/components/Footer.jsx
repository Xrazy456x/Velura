  ...
  return (
    <footer className="border-t border-stone-200 bg-white">
      <div className="section-shell grid gap-8 py-10 md:grid-cols-[1.4fr_1fr_1fr]">
        <div>
          <Link to={isAuthenticated ? "/portal" : "/"} className="flex items-center gap-3">
          ...
          <div className="mt-3 grid gap-2 text-sm text-stone-600">
            {isAuthenticated ? (
              <>
                ...
                <Link className="hover:text-berry" to="/portal/privacy">
                  Privacy
                </Link>
                <Link className="hover:text-berry" to="/portal/terms">
                  Terms
                </Link>
              </>
            ) : (
